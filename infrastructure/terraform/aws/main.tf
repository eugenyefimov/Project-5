# AWS Infrastructure - EKS Cluster with Multi-AZ Setup
# This configuration creates a production-ready EKS cluster with supporting services
...
resource "aws_s3_bucket" "app_assets" {
  bucket = "${var.project_name}-app-assets-${random_id.bucket_suffix.hex}"
